...
class RechingGoalPropDist():
    def __init__(self, lower_limit=-2, upper_limit=2, n=4):
        self.lower_limit = lower_limit
        self.upper_limit = upper_limit
        self.n = n

    def get_reached_goals_coordinates(self, data, number_of_robots):
        ...
        data1 = data1[data1['distance_reward'] == 15.0]

        return data1['reached_goal_x'].to_numpy(), data1['reached_goal_y'].to_numpy()
    ...
    def make_the_distribution(self, data, number_of_robots, path):
        X,Y = self.get_reached_goals_coordinates(data, number_of_robots)
